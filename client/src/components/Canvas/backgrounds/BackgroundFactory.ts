...
import { IClientBackground } from './Background';
...
export class ClientBackgroundFactory {
  private static backgroundInstances = new Map<string, IClientBackground>();
   ...
   */
  static getBackground(templateId: string, config: BackgroundConfig): IClientBackground {
   ...
   */
  private static createBackground(type: BackgroundType): IClientBackground {
    switch (type) {
      case 'solid':
   ...
   */
  private static getBackgroundType(background: IClientBackground): BackgroundType {
